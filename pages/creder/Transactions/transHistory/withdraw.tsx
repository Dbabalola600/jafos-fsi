...
export default function TransHistoryWith() {
    ...
    const showinfo = async () => {
        ...
        const response = await fetch("/api/transactionHistory/Creder/fetchWithdraw", { method: "POST", body: JSON.stringify(body) })
            ...
            >
                ...
                {hists.map((hist: {
                    ...
                    >
                        ...
                        <div
                            className={"text-red-500  mb-6 bg-black"}
